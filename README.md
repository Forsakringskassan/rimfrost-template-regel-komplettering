# Mallprojekt för Rimfrost komplettering regel

Det här är ett mallprojekt för att skapa en kompletteringsregel i Rimfrost-projektet.
...
Denna mall lämpar sig för kompletteringsregler som kräver interaktion 
med handläggare för att komplettera information i ett yrkande.
...
└── presentation/   REST-kontroller – RegelTemplateController (ärver RegelKompletteringController)
```
...
t.ex. om regelns namn är _Komplettera inkomst_:
```
package se.fk.github.regeltemplate -> se.fk.github.kompletterainkomst
RegelTemplateService       -> KompletteraInkomstService
RegelTemplateController    -> KompletteraInkomstController
```
...
Se [rimfrost-regel-rtf-manuell-komplettering](https://github.com/Forsakringskassan/rimfrost-regel-rtf-manuell-komplettering) för en färdig implementation av en kompletteringsregel.
